...
if TORCH_XLA_AVAILABLE:
    ...
    def patch_kv_cache():
        ...
        def wrapped_original_get_kv_cache_config_uniform_type(self, *args, **kwargs) -> KVCacheConfig:
            ...
            print(f"hosseins: {named_arguments=}")
            ...
            effective_available_memory = available_memory * len(_spmd_backend.device_ids)
    ...
    def patch_pallas_forward():
        ...
        def wrapped_forward(self, *args, **kwargs):
            # named_arguments = fetch_named_args(original_forward, self, *args, **kwargs)
            # layer = named_arguments["layer"]
            # query = named_arguments["query"]
            # key = named_arguments["key"]
            # value = named_arguments["value"]
            # kv_cache = named_arguments["kv_cache"]
            # attn_metadata = named_arguments["attn_metadata"]
            # output = named_arguments["output"]
            # print(f"hosseins: {named_arguments=}")
